...
public class ClientHandler implements Data {
    ...
    private boolean  logIn(String msg) throws IOException{
        ...
        String nick = server.getLogin().getNickByLoginPass(elements[1],elements[2]);
        if (nick != null){
    ...
    private void   regBox(String msg) throws IOException{
        String[] elements = msg.split(" ");
        String result = server.getRegister().checkNewUserData(elements[1],elements[2],elements[3]);
        switch (result){
            case SAME_LOGINPASS:
